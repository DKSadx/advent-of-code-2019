...
// original line intercept math by Paul Bourke http://paulbourke.net/geometry/pointlineplane/
// modified to fit the challenge
lineIntersection = (x1, y1, x2, y2, x3, y3, x4, y4) => {
  ...
  IntersectionPointDistance = Math.abs(x) + Math.abs(y);
  if (
    IntersectionPointDistance < shortestDistance ||
    shortestDistance === -1 ||
    shortestDistance === 0
  ) {
    shortestDistance = IntersectionPointDistance;
  }
};
